/* eslint-disable */
// Generated by Wrangler by running `wrangler types src/worker-configuration.d.ts` (hash: 093e856b37182a103a90e178f3f70624)
// Runtime types generated with workerd@1.20260616.1 2026-06-18 nodejs_compat
interface __BaseEnv_Env {
	APP_ORIGIN: "https://your-frontend-domain.example" | "http://localhost:5173";
	SUPABASE_URL: string;
	SUPABASE_SERVICE_ROLE_KEY: string;
	ROOM_HUB: DurableObjectNamespace<import("./worker").RoomHub>;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_ORIGIN" | "SUPABASE_URL" | "SUPABASE_SERVICE_ROLE_KEY">> {}
}
